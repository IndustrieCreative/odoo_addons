{
    ...
    'license': 'AGPL-3',
    'category': 'Technical',
    'summary': 'Allows to force a "no open" attribute on native list view',
    'description': """Although you can use the no_open attribute in a <list>
                     node when defining an embedded list inside a form, this
                     does not work in native list views. This module allows to
                     set "tree_no_open" class on list tag to prevent the
